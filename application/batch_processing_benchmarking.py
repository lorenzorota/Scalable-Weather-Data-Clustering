...
#normalise the data
[dataframeFull,minimums,maximums]=standardize_train_test_data(dataframeFull,dataframeFull.schema.names)
K = 5
convergeDist = 0.05
...
for percentage in percentages:
    df=dataframeFull.sample(False, percentage, seed=5)
    ...
    print("--- %s seconds for percentage %f---" % (time.time() - start_time_percentage, percentage))
    times[counter]=(time.time() - start_time_percentage)
    counter=counter+1
...
print('time for each percentage')
print(times)