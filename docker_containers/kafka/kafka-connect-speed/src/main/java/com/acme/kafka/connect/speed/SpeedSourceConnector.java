...
public class SpeedSourceConnector extends SourceConnector {

    private final Logger log = LoggerFactory.getLogger(SpeedSourceConnector.class);
    ...
    public void start(Map<String, String> originalProps) {
        ...
        config = new SpeedSourceConnectorConfig(originalProps);
